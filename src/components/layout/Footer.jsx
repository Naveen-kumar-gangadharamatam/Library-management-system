  ...
  return (
    <footer id="footer" className="bg-[#2c3e50] text-[#ecf0f1] pt-16">
      <div className="w-[90%] max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          <h3 className="text-2xl font-semibold mb-4">Naveen kumar Library Management</h3>
      ...
      <div className="mt-8 py-4 bg-[#34495e] text-center">
        <div className="w-[90%] max-w-7xl mx-auto">
          <p>&copy; 2024 Naveen kumar Library Management - All rights reserved | Designed By: Naveen kumar</p>
        </div>
      </div>
    </footer>
  );
